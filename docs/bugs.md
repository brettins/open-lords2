...
### BNEW-silent-shipment — A supply shipment with nowhere to stand is lost, in silence
...
### BNEW-before-label — `L2.eng` 37/1, *"Before"*, is drawn by nothing
...
### BNEW-court-arms — `L2.eng` 70/1, *"Arms"*, is drawn by nothing either
