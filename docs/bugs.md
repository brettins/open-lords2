...
### BNEW-overwrite-default — Typing your name over the default one leaves the tail of it behind
...
### BNEW-end-cancels-save — The End key cancels a save you have just confirmed
