...
### BNEW-idle-newborns — a growth season parks its newborns in Idle, and the next click hires them
...
arrives from. `docs/decisions.md` CNEW-cattle-floor separates this from the *other* cattle
