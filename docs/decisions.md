...
**CNEW-msg-ring-is-display — The message queue cannot be simulation state, and the binary is
what says so.**
...
**CNEW-msg-ring-in-the-save — A field that was always empty stopped being always empty, and
...
**CNEW-msg-guard-7-is-dead — An arm filed as `missing` cannot run, and two enumerations from
