...
**CNEW-gesture-kind — We reproduce *which* gestures a screen answers and not *what kind*
...
**CNEW-outline-half — A removal recorded in the input inventory left its other half in the
