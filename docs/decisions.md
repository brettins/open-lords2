...
**C57 — The flags and the minimap tint were not broken. The sidebar being dead under the
...
in a row in an arm nobody had read. C46's pattern, C52's pattern, and now C57's.
