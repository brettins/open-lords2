...
Castle designer: Screen_CastleBuild `0x00419789`, Screen_CastleBuildPanel `0x004198AA`, CastleBuild_Select `0x00436B22` and CastleBuild_Confirm `0x00436B59` are a picture-and-stats browser over one integer 0..4; "design" occurs twice in L2.eng and never in Lords2.exe, both in help text; ours (crates/l2-game/src/screens/castle/mod.rs, 25 tests in crates/l2-game/tests/castles.rs) reproduces all five buttons, both refusal guards (messages 0x93 and 0x122), the net materials and the CastleN.smk.
