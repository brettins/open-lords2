...
**CNEW-industry-base — the `Industry` record base is county `+0x294`, and four
...
**CNEW-stored-fields — "a stored field our importer drops" is now a red test,
and the inventory that makes it one found 153 of 241 undecided.**

C142 and CNEW-industry-base were one defect found twice by a player, with the
...
−30, and they are now `i8`. The decompiled corpus still prints the pre-CNEW-industry-base
...
**CNEW-mercenary-bands — no loaded game and no new game had a single mercenary
band, and thirteen of CNEW-stored-fields' 64 exclusions are things a player can
see.**

CNEW-stored-fields left county `+0x1AD` excluded as *"a cache of
