...
**C43 — `L2_maps.dat` is not what the game draws. Every county town on the map was rendered
...
**C44 — The county strip's happiness figure was right-anchored on a coordinate that is a
...
**C45 — The campaign sidebar's five buttons were one button of ours, drawn over.**
