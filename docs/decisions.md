...
**CNEW-tooltips — the original has a generic tooltip layer, and `docs/screens.md` said it
did not.**
...
**CNEW-garrison-shield — only the town arm guards a zero shield, and one document said both
did.**
...
**CNEW-unit-banner — every army and every mob carries a banner, and the section describing
...
**CNEW-far-zoom-caption — the words in the far-zoom strip are the original's, and we
