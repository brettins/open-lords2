...
**CNEW-cancel-on-confirm — the third invented hotspot sitting on a live control, and the
...
**CNEW-painter-not-table — every control on screen `0x11` was 88 pixels from where the game
...
**CNEW-dead-strip — `FUN_00437107` is a cut control strip for move-order mode, and settling
...
**CNEW-two-records-one-arm — `docs/arms.json` counts arms and had four filed twice, and one
...
**CNEW-levy-does-not-commit — the raise-army screen's right release was reproduced, recorded
...
**CNEW-dead-row — the sidebar strip is 29 pixels tall and we had 30, because a plate's
...
**CNEW-minimap-under-the-panel — the arm was reproduced on four screens and absent on the
