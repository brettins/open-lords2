...
**CNEW-fog — The Exploration option flipped a flag nothing read, and the fog is built now.**
...
**CNEW-field-panel — A left click on a field opens the information panel, and the panel says what the field is.**
