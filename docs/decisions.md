...
**CNEW-surfaces — The castle's surface model was inverted, and a besieger could not win because of it.**
...
**CNEW-smash — A breach is nine cells wide, and ours was one.**
...
**CNEW-approach — A fresh siege opens at approach score 500, and the moat is what puts it back to zero.**
...
**CNEW-0055307c — `_DAT_0055307C` counts gaps in the wall; it is not the moat flag.**
...
**CNEW-lineclear — `Path_LineIsClear` is not a line, not a predicate, and not free of side effects — and that is where 848 men were stuck.**
...
**CNEW-height — The mover never enforced the height rule, so the one constant the wall depends on could not be wrong.**
...
**CNEW-defenceposts — The garrison's twenty defence posts are the holes a catapult has made, and we invented twenty of them at deployment.**
...
**CNEW-aiengines — "The AI never orders siege engines" was a true statement about the wrong function.**
