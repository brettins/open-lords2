...
**CNEW-overlay-palette — A window over a page is in the page's colours, and we asked the
window.**
...
**CNEW-pulse-stamp — `Tick_Pulses` resets its stamp, and the armoury carried the remainder.**
