...
1. **A player performs a gesture the original responds to and ours does not.** This is now
   ...
   arms enumerated so far we reproduce **<!--fig:arms-reproduced-->190<!--/fig--> of
   <!--fig:arms-live-->218<!--/fig--> live arms (<!--fig:arms-pct-->87<!--/fig-->%)** — so
...
<!--fig:tests-->2,338<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
