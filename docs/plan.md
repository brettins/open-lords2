...
`docs/decisions.md` C61 has the four corrections that fell out of it.
...
that had been invisible since the importer was written (`docs/decisions.md` C61).
...
<!--fig:tests-->1,749<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
