...
1. **A player performs a gesture the original responds to and ours does not.** This is now
   ...
   arms enumerated so far we reproduce **<!--fig:arms-reproduced-->183<!--/fig--> of
   <!--fig:arms-live-->211<!--/fig--> live arms (<!--fig:arms-pct-->87<!--/fig-->%)** — so
...
3. **A screen shows something the original does not, or fails to show something it does.**
   ...
   **The other <!--fig:draws-screens-->51<!--/fig--> screens** make
   ...
   <!--fig:draws-ours-->419<!--/fig-->: <!--fig:draws-pct-->41<!--/fig-->%.
...
<!--fig:tests-->2,234<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
