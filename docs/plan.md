...
> the first time. `docs/decisions.md` CNEW-revolt.
>
...
> band 3 and a dead arm (`docs/bugs.md` BNEW-summer-climate). `docs/kingdom.md` §7.3.
> `docs/decisions.md` CNEW-weather-climate, whose lesson is that **an open question naming
...
<!--fig:tests-->1,981<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
