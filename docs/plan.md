...
<!--fig:functions-->981<!--/fig--> of <!--fig:binary-functions-->2,452<!--/fig-->
...
<!--fig:tests-->2,013<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
...
* **Naming more of the binary for its own sake.** <!--fig:functions-->981<!--/fig--> of
