...
1. **A player performs a gesture the original responds to and ours does not.** This is now
   ...
   arms enumerated so far we reproduce **<!--fig:arms-reproduced-->194<!--/fig--> of
   <!--fig:arms-live-->225<!--/fig--> live arms (<!--fig:arms-pct-->86<!--/fig-->%)** — so
...
3. **A screen shows something the original does not, or fails to show something it does.**
   ...
   **The other <!--fig:draws-screens-->51<!--/fig--> screens** make
   ...
   <!--fig:draws-ours-->437<!--/fig-->: <!--fig:draws-pct-->43<!--/fig-->%.
   ...
   **And the half a call count cannot see.** Of our marks on those 51 screens,
   <!--fig:draws-real-->461<!--/fig--> go through the game's own artwork and
...
<!--fig:tests-->2,405<!--/fig-->. **Do not quote a count here that nothing recomputes**: mark
