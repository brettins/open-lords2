...
(CNEW-industry-base); the three farm words are not yet, and are measured zero on England turn
...
stone's rather than wood's, and there is no off-by-one.** `docs/decisions.md` CNEW-industry-base.
