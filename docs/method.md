...
* **It can be less precise than the code, and then the code is what shipped.** Its *Retreats
  ...
  exactly one AI handler (`decisions.md` C36). Record both; do not implement the errata over
  the executable.
...
**Reading one branch and reporting the function.** C36, and it is C31's own lesson applied
...
always more of the binary to name — <!--fig:functions-->681<!--/fig--> of <!--fig:binary-functions-->2,452<!--/fig--> functions so far, about <!--fig:functions-pct-->28<!--/fig-->%.
