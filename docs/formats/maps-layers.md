...
**Two of those labels were the wrong way round until `docs/decisions.md` C25 and C43.**
...
belongs, which is what ours did; `docs/decisions.md` C43 is the whole of it.
...
C43 has the code: the tiles are towns, and the three groups are the three **village sizes**,
