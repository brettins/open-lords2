...
/// the target `BattleMan_Step` (`0x0048F1DD`) wrote a few lines above. `[V]`,
/// `docs/battle.md` §8.3a.
...
/// the cap *and* over five times the straight line is abandoned;
/// `BattleMan_Step` (`0x0048F1DD`) then writes `tgX, tgY = mapX, mapY`.
///
