...
//! missed the twelve of C38 — and leaving it beside a derived check is how the
//! derived one rots.
//!
...
fn the_body_covers_a_fixed_and_known_number_of_bytes() {
    ...
    assert_eq!(c.finish().len, 56_532, "the state encoding changed - bump VERSION?");
}
...
// C38 delivered: the field list is *derived from the struct definitions*
...
///
/// This is the guard `docs/decisions.md` C30 said was missing and C38 wrote.
