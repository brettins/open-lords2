...
fn the_body_covers_a_fixed_and_known_number_of_bytes() {
    ...
    // accumulators over 6 realm slots (96); +132 at 14 for the AI's war plan —
    // six bytes and four words a realm over 6 realm slots.
    //
    ...
    // sure it does.
    assert_eq!(c.finish().len, 56_867, "the state encoding changed - bump VERSION?");
}
