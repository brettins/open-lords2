...
//! bugs.md` BNEW-turn-timer-skips-a-turn); a fought battle's `+10`
...
impl TurnClock {
    ...
    /// `docs/bugs.md` BNEW-turn-timer-skips-a-turn has what follows from it.
    ...
    pub fn tick(&mut self, f: Frame) -> Tick {
        ...
        // `docs/bugs.md` BNEW-turn-timer-skips-a-turn.
...
mod tests {
    ...
    /// **`BNEW-turn-timer-skips-a-turn`: the countdown runs before the restart.**
    ///
