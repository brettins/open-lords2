...
//! for every state a running game can be in. `docs/decisions.md` CNEW-bottom.
//!
...
/// CNEW-bottom. Nobody had ever quoted it, and the first time it *was* quoted
...
fn eleven_of_the_installs_771_sounds_are_reachable() {
    ...
    assert_eq!(
        ...
        "the set of sounds this engine can reach has changed. If a call site was \
         ...
         docs/mechanics.md and docs/decisions.md CNEW-bottom moves with it."
    );
