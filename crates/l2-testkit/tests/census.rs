...
const INVENTORY: &[(&str, &str, usize)] = &[
    ...
    ("crates/l2-game/tests/battle_picture.rs", "install", 7),
    ...
    ("crates/l2-game/tests/job_bodies.rs", "england", 9),
    ...
    ("crates/l2-game/tests/screens.rs", "england", 95),
    ...
    ("crates/l2-sim/tests/castle_layout.rs", "install", 11),
