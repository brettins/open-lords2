...
const INVENTORY: &[(&str, &str, usize)] = &[
    ...
    ("crates/l2-game/tests/audio_screens.rs", "install", 7),
    ("crates/l2-game/tests/audio_wiring.rs", "install", 9),
    ("crates/l2-game/tests/battle_picture.rs", "install", 4),
    ("crates/l2-game/tests/chrome_text.rs", "england", 15),
    ("crates/l2-game/tests/differential.rs", "fixture", 3),
    ("crates/l2-game/tests/ground.rs", "install", 7),
    ("crates/l2-game/tests/industry.rs", "england", 4),
    ("crates/l2-game/tests/job_bodies.rs", "england", 6),
    ("crates/l2-game/tests/job_bodies.rs", "fixture", 4),
    ("crates/l2-game/tests/labour_move.rs", "england", 3),
    ...
    ("crates/l2-game/tests/screens.rs", "england", 92),
