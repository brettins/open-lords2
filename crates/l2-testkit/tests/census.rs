...
const INVENTORY: &[(&str, &str, usize)] = &[
    ...
    ("crates/l2-game/tests/ai_war.rs", "england", 1),
    ...
    ("crates/l2-game/tests/screens.rs", "england", 50),
    ...
    ("crates/l2-view/tests/install.rs", "install", 20),
];
