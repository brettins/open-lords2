...
<<<<<<< HEAD
**<!--fig:tests-->1,628<!--/fig--> tests pass**, and roughly a third of them assert things
=======
**<!--fig:tests-->1,628<!--/fig--> tests pass**, and roughly a third of them assert things
>>>>>>> f1f678c (Give the game sound, and find that the music is a progress bar)
...
**<!--fig:functions-->741<!--/fig-->**, plus <!--fig:globals-->461<!--/fig--> globals; most
